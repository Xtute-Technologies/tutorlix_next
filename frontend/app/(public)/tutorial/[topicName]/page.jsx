          ...
          <CardContent className="p-4 md:p-5 space-y-4">
            <div className="space-y-1">
              ...
              <p className="text-sm text-slate-600">
                Select a concept to preview its attached note.
              </p>
            </div>
            ...
            <CardContent className="p-6 md:p-8 space-y-5">
              <div className="flex items-center gap-3 text-slate-900">
                ...
                <h2 className="text-xl font-semibold">
                  {selectedConcept?.title || 'Concept notes'}
                </h2>
              </div>

              {selectedConcept?.noteSummary ? (
                <p className="text-sm leading-7 text-slate-600">{selectedConcept.noteSummary}</p>
              ) : null}
                  ...
                  <div className="space-y-3 rounded-2xl border bg-slate-50 p-5">
                    ...
                    <div className="space-y-2">
                      ...
                      {selectedNote.description ? (
                        <p className="text-sm leading-7 text-slate-600">{selectedNote.description}</p>
                      ) : null}
                    </div>
