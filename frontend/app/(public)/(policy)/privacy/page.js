export const metadata = {
  title: 'Privacy Policy | Tutorlix',
  description: 'Learn how Tutorlix collects, uses, and protects your personal information.',
};
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-3xl mx-auto prose prose-slate lg:prose-lg">
        ...
        <p className="lead">Privacy Policy for Tutorlix</p>
        <p className="text-sm text-gray-500">Last updated: February 06, 2024</p>
        ...
        <ul>
          ...
          <li>
            <strong>Application</strong> refers to TutorLix, the software
            program provided by the Company.
          </li>
          <li>
            <strong>Company</strong> (referred to as either "the Company", "We",
            "Us" or "Our" in this Agreement) refers to Tutorlix.
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to Tutorlix, accessible from{' '}
            <a
              href="https://tutorlix.com"
              target="_blank"
        ...
        <div className="pl-4 border-l-4 border-slate-200 my-4">
        ...
        <ul>
          <li>
            ...
            <a
              href="https://tutorlix.com/contact"
              target="_blank"
              rel="noopener noreferrer"
            >
              https://tutorlix.com/contact
            </a>
          </li>
        </ul>
      </div>
