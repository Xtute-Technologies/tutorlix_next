...
import { Plus, Pencil, Trash2, Calendar, Loader2, Mail, Phone, MapPin, Shield, Clock, Eye } from "lucide-react";
import { z } from "zod";
...
export default function UsersPage() {
  ...
  const fetchSingleUser = async (id) => {
    try {
      ...
      setMessage({ type: "error", text: "Failed to load user details from URL" });
    } finally {
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="flex gap-1 justify-end">
          {/* View Icon (Eye) */}
          <Button variant="ghost" size="icon" onClick={() => setViewingUser(row.original)} title="View Details">
              ...
              <div className="space-y-6 p-4">
                ...
                <div className="flex flex-col items-center text-center gap-3 pb-6 border-b">
                  <Avatar className="h-24 w-24 border-4 border-slate-50 shadow-sm">
                    <AvatarImage src={viewingUser.profile_image} alt={viewingUser.first_name} className="object-cover" />
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex justify-center gap-2 mt-2">
                      ...
                      <Badge
                        variant={viewingUser.is_active ? "default" : "destructive"}
                        className={viewingUser.is_active ? "bg-emerald-600" : ""}>
