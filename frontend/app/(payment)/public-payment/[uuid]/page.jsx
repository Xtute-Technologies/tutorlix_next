...
export default function PublicPaymentPage() {
    ...
    // 1️⃣ EXPIRED LINK (HIGHEST PRIORITY)
    if (bookingData?.booking?.payment_status === "expired") {
        const expiredAt = bookingData.booking.expired_at;
                ...
                <Card className="w-full max-w-md shadow-lg">
                    ...
                    <CardContent className="text-center space-y-4">
                        <p className="text-sm text-gray-600">
                            The payment link for this booking has been expired.
                        </p>
                ...
                <Card className="w-full max-w-lg shadow-lg">
                    ...
                    <CardFooter className="bg-gray-50 rounded-b-lg">
                        <Button
                            ...
                            disabled={processing || booking.payment_status === "expired"}
                        >
                            {processing ? (
                                <>
